...
"Polylang - theme translation" is highly efficient because the skaner is worked only on admin dashbord in tab:
Settings -> Languages -> String translation.
...
1. Upload the "Polylang - theme translation" folder to the /wp-content/plugins/ directory on your web server.
